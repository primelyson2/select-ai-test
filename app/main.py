...
from app.routers import agents, auth as auth_router, chat, chat2, chat_config, chat_tl, databases, feedback, history, history2, nl2sql, objects, persona_analysis, personas, predefined, profiles, vpd
...
app.include_router(chat_config.router, prefix="/api")
